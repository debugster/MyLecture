...
int main() {
    ...
    make_heap(myVector.begin(), myVector.end(), compare); // myVector becomes a Min Heap
    cout << "Initial Heap Min : " << myVector.front() << endl;
    ...
    pop_heap(myVector.begin(), myVector.end(), compare); // Heap Min is moved to the last position
    myVector.pop_back(); // last element is popped out
    cout << "Heap Min after pop : " << myVector.front() << endl;

    myVector.push_back(25); // a new element is pushed into myVector
    push_heap(myVector.begin(), myVector.end(), compare); // a new Min Heap is formed
    cout << "Heap Min after push : " << myVector.front() << endl;
    ...
    sort_heap(myVector.begin(), myVector.end(), compare); // sorts the elements of Max Heap in descending order
